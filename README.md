...
```sh
  cd my-folder
  git clone git@github.com:bohaz/Vet-clinic-database.git
```
...
- Twitter: [@Ricardo29115571](https://twitter.com/home)
...
Feel free to check the [issues page](https://github.com/bohaz/Vet-clinic-database/issues).
...
This project is [MIT](https://github.com/bohaz/Vet-clinic-database/blob/create-animals-table/MIT.md) licensed.
